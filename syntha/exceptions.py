...
class ErrorHandler:
    ...
    def handle_error(self, error: Exception, context: Dict[str, Any] = None) -> SynthaError:
        """
        ...
        # Log the error
        if self.logger:
            self.logger.error(f"Error transformed: {syntha_error}", extra=syntha_error.to_dict())
