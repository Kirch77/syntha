...
class SynthaFormatter(logging.Formatter):
    ...
    def _format_json(self, record: logging.LogRecord) -> str:
        ...
        if self.include_context:
            for attr in ['agent_name', 'operation', 'context_key', 'performance_metrics']:
...
class SecurityLogger:
    ...
    def log_access_attempt(self, agent_name: str, resource: str, 
    ...
    def log_authentication_event(self, agent_name: str, success: bool, 
                                method: str = None, reason: str = None):
