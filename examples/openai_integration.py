...
def main():
    ...
    messages = [
        ...
        {"role": "user", "content": "Help me create a marketing strategy for our product launch campaign."}
    ]
    ...
    strategy_update = tool_handler.handle_tool_call(
        ...
        value=json.dumps({
            ...
            "timeline": "Q1 2025",
            "budget_allocation": {"social_media": 0.4, "email": 0.3, "content": 0.3}
        }),
