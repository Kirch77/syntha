...
from syntha import ContextMesh, inject_context_into_prompt, build_message_prompt
...
"""
    ...
    resolution_rate = int((support_data["resolved_tickets"] / support_data["total_tickets"]) * 100)
    ...
    advanced_injected = inject_context_into_prompt(
        ...
        additional_context={
            "tier_specific_instructions": tier_instructions.get(customer_data["tier"], ""),
            "priority_specific_guidance": priority_guidance.get(current_issue_data["priority"], ""),
