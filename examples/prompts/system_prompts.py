...
def main():
    ...
    context.push(
        "product_roadmap",
        {"current_version": "2.1", "next_release": "2025-02-15", "features": ["AI Analytics", "Mobile App"]},
    ...
    context.push("campaign_data", {"current": "Q1 Growth", "budget": 50000}, topics=["marketing"])
    ...
    print(f"   Change in length: {len(updated_sales_prompt) - len(sales_prompt):+d} characters")
    ...
    context.push("business_metric", "Customer churn reduced by 15%", topics=["business"])
