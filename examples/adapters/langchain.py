...
def main():
    ...
    context.push("research_progress", {
    ...
    analysis_result = handler.handle_tool_call(
        ...
        value={
            "key_findings": ["Market growing at 15% CAGR", "3 main competitor gaps identified"],
            "recommendations": ["Focus on SMB segment", "Accelerate product development"],
