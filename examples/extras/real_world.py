...
def sales_intelligence_use_case():
    ...
    context.push("lead_profile", {
        "company": "TechCorp Solutions",
        "contact": "Michael Chen",
        "title": "VP of Operations",
        "company_size": "500-1000 employees",
        "industry": "Financial Services",
        "pain_points": ["Manual processes", "Compliance overhead", "Scaling challenges"],
...
def content_operations_use_case():
    ...
    writer.handle_tool_call(
        ...
        value={
            ...
            "word_count": 1850,
            "target_keywords": ["innovation strategies", "sustainable growth", "business transformation"],
            "outline": [
