...
def main():
    ...
    context1.push("user_preferences", {
        "theme": "dark",
        "language": "en",
        "notifications": True,
        "timezone": "UTC"
    ...
    context1.push("dev_notes", "Completed user authentication module", topics=["development"])
    ...
    print(f"   Project progress: {project_status['progress'] if project_status else 'Not found'}%")
    
    # 8. Add new data in the new session
    print("\n➕ Adding new data in restored session:")
    
    context2.push("session_2_data", {
        "session_id": "sess_002",
