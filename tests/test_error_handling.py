...
class TestToolExecutionErrors:
    ...
    def test_nonexistent_tool_execution_error(self):
        ...
        assert result["success"] is False
        assert "error" in result
        assert "Unknown tool" in result["error"] or "nonexistent_tool" in result["error"]
...
class TestErrorContext:
    ...
    def test_framework_error_context(self):
        ...
        try:
            ...
            assert any("supported" in suggestion.lower() for suggestion in e.suggestions)
    ...
    def test_langchain_error_suggestions(self):
        ...
        try:
            ...
            assert any("pip install" in suggestion for suggestion in e.suggestions)
...
class TestErrorRecovery:
    ...
    def test_partial_framework_failure_recovery(self):
        ...
        with patch.object(LangChainAdapter, 'create_tool', side_effect=SynthaFrameworkError("Mock error", "langchain")):
