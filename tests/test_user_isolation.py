...
class TestUserIsolation:
    ...
    def test_unsubscribe_isolation(self):
        ...
        self.user1_handler.handle_tool_call("subscribe_to_topics", topics=["topic1", "topic2"])
        self.user2_handler.handle_tool_call("subscribe_to_topics", topics=["topic1", "topic2"])
        
        # User 1 unsubscribes from topic1
        self.user1_handler.handle_tool_call("unsubscribe_from_topics", topics=["topic1"])
    ...
    def test_topic_deletion_isolation(self):
        ...
        self.user1_handler.handle_tool_call("subscribe_to_topics", topics=["shared_topic"])
        self.user2_handler.handle_tool_call("subscribe_to_topics", topics=["shared_topic"])
        ...
        self.user1_handler.handle_tool_call("delete_topic", topic="shared_topic", confirm=True)
        ...
        user2_context = self.user2_handler.handle_tool_call("get_context", keys=["user2_data"])
    ...
    def test_persistence_isolation(self):
        ...
        # User 1 creates context
        self.user1_handler.handle_tool_call("subscribe_to_topics", topics=["persistent"])
        self.user1_handler.handle_tool_call(
            "push_context",
            key="persistent_data",
        ...
        user1_context = self.user1_handler.handle_tool_call("get_context", keys=["persistent_data"])
        assert user1_context["context"]["persistent_data"] == "This should persist"
        
        # User 2 should not have access to User 1's data
        user2_context = self.user2_handler.handle_tool_call("get_context", keys=["persistent_data"])
