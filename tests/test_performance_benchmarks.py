...
class TestToolCreationPerformance:
    ...
    def test_framework_comparison_speed(self):
        ...
        for framework, result in framework_results.items():
            print(f"  {framework:>10}: {result['average_time']*1000:6.2f}ms avg, {result['times_per_second']:6.1f} sets/sec")
...
class TestCachingPerformance:
    ...
    def test_cache_hit_vs_miss_performance(self):
        ...
        print(f"  Speedup:    {cold_result['average_time']/warm_result['average_time']:.1f}x")
...
class TestMemoryUsage:
    ...
    def test_adapter_cache_memory_usage(self):
        ...
        print(f"  Memory delta:    {memory_delta:.2f} MB")
        print(f"  Memory per adapter: {memory_delta/max(cache_info['cache_size'], 1):.2f} MB")
...
class TestScalabilityBenchmarks:
    ...
    def test_multiple_handlers_performance(self):
        ...
        for count in [10, 50, 100]:
            result, duration = self.benchmark.measure_time(create_multiple_handlers, count)
