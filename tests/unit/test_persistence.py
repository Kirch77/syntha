...
class TestSQLiteBackend:
    ...
    def test_sqlite_cleanup_expired(self, tmp_path):
        ...
        backend.save_context_item("expired1", "value1", [], 1, current_time - 100)  # Expired
        backend.save_context_item("expired2", "value2", [], 1, current_time - 50)   # Expired
...
class TestPostgreSQLBackend:
    ...
    def test_postgresql_basic_operations(self):
        ...
        try:
            ...
            backend.save_context_item("pg_test_key", "pg_test_value", ["agent1"], None, time.time())
...
class TestDatabaseBackendFactory:
    ...
    def test_create_postgresql_backend(self):
        ...
        backend = create_database_backend("postgresql", connection_string=connection_string)
...
class TestDatabaseErrorHandling:
    ...
    def test_sqlite_connection_to_readonly_directory(self):
        ...
        try:
            ...
            with pytest.raises(Exception):  # Could be PermissionError or OperationalError
                backend.connect()
    ...
    def test_postgresql_connection_failure(self):
        ...
        backend = PostgreSQLBackend(connection_string="postgresql://invalid:invalid@nonexistent:5432/invalid")
    ...
    def test_sqlite_concurrent_writes(self, tmp_path):
        ...
        try:
            for worker_id in range(3):
                ...
                thread = threading.Thread(target=writer_worker, args=(worker_id, backend))
