...
class TestPromptBuilders:
    ...
    def setup_method(self):
        ...
        self.mesh.push("campaign", {"name": "Launch", "budget": 10000}, subscribers=["MarketingBot"])
    ...
    def test_include_context_header_option(self):
        ...
        prompt_with_header = build_system_prompt("MarketingBot", self.mesh, include_context_header=True)
        prompt_without_header = build_system_prompt("MarketingBot", self.mesh, include_context_header=False)
