...
class TestToolHandlerFrameworkMethods:
    ...
    def test_create_framework_integration(self):
        ...
        integration = self.handler.create_framework_integration("openai", existing_tools)
        ...
        assert integration["total_tools"] == integration["syntha_tool_count"] + integration["existing_tool_count"]
...
class TestParameterConversionIntegration:
    ...
    def test_anthropic_parameter_conversion(self):
        ...
        # Test comma-separated string conversion
        result = anthropic_handler("subscribe_to_topics", {"topics": "topic1,topic2,topic3"})
        assert result["success"] is True
...
class TestFactoryIntegration:
    ...
    def test_caching_behavior(self):
        ...
        assert [t["function"]["name"] for t in tools1] == [t["function"]["name"] for t in tools2]
